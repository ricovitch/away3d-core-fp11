package away3d.core.pick
{
	...
	public class ShaderPicker implements IPicker
	{
		...
		private function initObjectProgram3D():void
		{
			...
			_objectProgram3D.upload(new AGALMiniAssembler().assemble(Context3DProgramType.VERTEX, vertexCode, AGALProgram3DCache.AGAL_VERSION),
				new AGALMiniAssembler().assemble(Context3DProgramType.FRAGMENT, fragmentCode, AGALProgram3DCache.AGAL_VERSION));
		}
		...
		private function initTriangleProgram3D():void
		{
			...
			_triangleProgram3D.upload(new AGALMiniAssembler().assemble(Context3DProgramType.VERTEX, vertexCode, AGALProgram3DCache.AGAL_VERSION),
				new AGALMiniAssembler().assemble(Context3DProgramType.FRAGMENT, fragmentCode, AGALProgram3DCache.AGAL_VERSION));
		}
